...
def seed(seed: Optional[int], /, *, one_cuda_seed: bool = False) -> int:
    ...
    **Usage**
    ...
    Args:
        seed: an integer from `[0, 2**64)` used to compute diverse seeds
    ...
    Returns:
        the provided ``seed`` or the generated one if ``seed=None``.
    """
    # The implementation is based on:
    # - https://github.com/pytorch/pytorch/issues/5059#issuecomment-817392562
    # - https://github.com/Lightning-AI/lightning/pull/6960#issuecomment-819672341
    if seed is None:
        seed = secrets.randbelow(_2_pow_64)
    if not (0 <= seed < _2_pow_64):
        raise ValueError(
            'seed must be a non-negative integer from [0, 2**64).'
            f' The provided value: {seed=}'
        )
